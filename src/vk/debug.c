...
void debug_utils_messenger_destroy(
    ...
    fp = (PFN_vkDestroyDebugUtilsMessengerEXT)vkGetInstanceProcAddr(
...
void debug_utils_messenger_set_create_info(
    VkDebugUtilsMessengerCreateInfoEXT *vk_debug_utils_messenger_ci
) {
    *vk_debug_utils_messenger_ci       = (VkDebugUtilsMessengerCreateInfoEXT){0};
    ...
    vk_debug_utils_messenger_ci->messageSeverity = VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT
